   ...
   public class Program
    {
        ...
        {
           string firstname =" wint";
           string lastname  = "aung";
           string result =ConcatNames (firstname,lastname );
        ...
        {     
                 ...
                 string str = $"{x} {firstElement} {lengthOfSubsring}";
                 return (str .Substring (firstElement,lengthOfSubsring));
