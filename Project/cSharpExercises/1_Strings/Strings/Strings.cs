...
namespace StringManipulationChallenge
{
    public class Program
    {
        ...
        {
        string retrn = usersString.ToLower();
        return retrn;
           // throw new NotImplementedException("StringToUpper method not implemented.");
        }
        ...
        /// <returns></returns>
        public static string StringSubstring (string x, int firstElement, int lastElement )
        {     
              string str = $"{x} {firstElement} {lastElement}";
return (str .Substring (firstElement,lastElement));
        }
        ...
        {
            string str = $"{userInputString} {charUserWants}";
return(str.IndexOf (charUserWants));
